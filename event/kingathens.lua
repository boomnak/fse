...
elseif vars.SOKevent == 2 then
  ...
  talk("King: We were unsure of what happened after\n the burst of light.")
  talk("King: You just seemed to vanish into thin air.")
  talk("Player: I don't know what happened either.")
  talk("King: Interesting, so there is more to you\n than I thought.")
  talk("King: Tell you what, I'll excuse you of your\n crime.")
  talk("Player: Did you finally realize that I did\n not steal this potion?")
  talk("King: In return for me excusing you, you must\n become one of my guards.")
  ...
  while options == false do 
    if down("interact") == true then
      clearMessage()
      vars.teamAdoom = true
      talk("King: Good, now then go and see commander\n Alexander for your first task")
      talk("Quest Received: Talk to Alexander!")
      vars.eventSOK = 3
      options = true
    elseif down("item") == true then
      clearMessage()
      talk("King: Well then, you are still considered\n a prisoner after all.")
      talk("King: I guess I'll have to take things into\n my own hands then!")
      battle({"kingathens"})
      talk("The king has been slain... Mission Failed \n(Summit of Kings)")
...
elseif vars.SOKevent == 8 then
  ...
  talk("Announcer: and King Athens of Adoom have\n all arrived")
  talk("Announcer: And so begins the 34th Summit\n of Kings!")
  talk("King Taha: Gentlemen! I shall start this\n evening with my opening remarks.")
  talk("King Taha: As you all know, our great kingdoms\n have now been at peace for a long time.")
  talk("King Taha: With this peace, we have managed to\n grow as kingdoms and now we sit here today as comrads.")
  fadeout(0.1)
  sleep(0.1)
  fadein(0.1)
  ...
  talk("King Fowlin: A masked figure appeared out of\n no where and assassinated King Taha!")
  talk("H'ataha Guard: You expect us to believe that!")
  talk("H'ataha Guard: That a man appeared out of no\n where in the worlds most secured meeting and murdered our king.")
  talk("H'ataha Guard: I see now, this was a organized\n attack by all of your kingdoms against ours!")
  talk("H'ataha Guard: By the honour of king Taha, you\n are all uder arrest!")
  talk("King Vad: How disrespectful, you should all know\n your place.")
  talk("King Vad: This meeting was a bore anyway.")
  removeEntity(kingVadNum)
  talk("King Fowlin: Athens! you and your men should leave\n while you can, this situation is about to get messy.")
  ...
  talk("King: Now go and try and find out more about this\n masked figure while we start defensive preparations.")
